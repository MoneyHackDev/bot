...
class Zefoy:
    def __init__(self):
        ...
        self.proxy = {'https': 'your_proxy_url_here'}  # Add your proxy URL here
        self.headers = {
        ...
        self.temp_captcha_file = 'captcha.png'
        ...
        if not os.path.exists(self.config_file):
            ...
            with open(self.config_file, 'w', encoding='utf-8', errors='ignore') as f:
    ...
    def get_captcha(self):
        if os.path.exists(self.session_file):
            self.session.cookies.set("PHPSESSID", open(self.session_file, encoding='utf-8').read(), domain='zefoy.com')
        ...
        try:
            ...
            open(self.temp_captcha_file, 'wb').write(request.content)
    ...
    def send_captcha(self, new_session=False):
        ...
        captcha_solve = self.solve_captcha(self.temp_captcha_file)[1]
        ...
        if 'Enter Video URL' in request.text:
            ...
            open(self.session_file, 'w', encoding='utf-8').write(self.session.cookies.get('PHPSESSID'))
            self.video_key = request.text.split('" placeholder="Enter Video URL"')[0].split('name="')[-1]
    ...
    def solve_captcha(self, path_to_file=None, b64=None, delete_tag=['\n', '\r']):
        if path_to_file:
            ...
            open(self.temp_file, 'wb').write(base64.b64decode(b64))
            task = self.temp_file
