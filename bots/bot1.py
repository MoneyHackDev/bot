...
class Zefoy:
    def __init__(self):
        ...
        self.proxy = {'http': 'your_proxy_url_here'}  # Add your proxy URL here
        self.headers = {
...
def load_config(self):
    try:
        ...
        self.update_config()  # Create default config if file doesn't exist
    except json.decoder.JSONDecodeError:
        print("Error decoding JSON. Using default config...")
        self.update_config()  # Create default config if JSON decoding fails
